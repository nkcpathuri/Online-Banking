...
<head>
  ...
  <style>
    ...
    margin: 0;
    padding: 0;
    background-image: url("https://image.lexica.art/full_jpg/3bc7ceaf-22f0-4265-9680-cc142e5df2e7");
...
List<Transfer> emplist = adminService.viewAllTran();

for(Transfer emp : emplist)
{
	  %>
