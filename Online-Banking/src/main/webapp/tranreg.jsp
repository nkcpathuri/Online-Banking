...
<head>
    ...
    margin: 0;
    padding: 0;
    background-image: url("https://image.lexica.art/full_jpg/64aca7ee-4ab9-478d-8366-74713afc2810");
...
<div class="card">
    <h2><u>Transfer</u></h2>
    <form method="post" action="addtran.jsp">
        <table align="center">
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="acc" required>
                </td>
            </tr>
            <tr>
                <td><b>Amount</b></td>
